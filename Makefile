...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Feb 2 17:28:34 2017
# Project:  Elysium-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile Elysium-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/Elysium/src/leveldb/libleveldb.a /tmp/Elysium/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: Elysium-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile Elysium-qt.pro
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /tmp/Elysium/src/leveldb/libleveldb.a; cd /tmp/Elysium/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/tmp/Elysium/src/leveldb/libleveldb.a: FORCE
	cd /tmp/Elysium/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/tmp/Elysium/build/build.h: FORCE
	cd /tmp/Elysium; /bin/sh share/genbuild.sh /tmp/Elysium/build/build.h
